...
class Derm12345Processor(BaseProcessor):
    """Processor for DERM12345 dataset metadata."""
    
    def __init__(self):
        super().__init__('DERM12345')
    
    def process(self, dataset_path: Path) -> List[Dict[str, Any]]:
        """Process DERM12345 dataset metadata."""
        
        # Look for the metadata file
        metadata_file = dataset_path / 'derm12345_metadata_2025-05-22.csv'
