...
class MSKCCProcessor(BaseProcessor):
    """Processor for MSKCC dataset metadata."""
    
    def __init__(self):
        super().__init__('MSKCC')
    
    def process(self, dataset_path: Path) -> List[Dict[str, Any]]:
        """Process MSKCC dataset metadata."""
        
        # Look for the metadata file
        metadata_file = dataset_path / 'mskcc-consecutive-biopsies-across-year-2020_cohort_metadata_2025-05-22.csv'
